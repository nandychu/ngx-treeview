...
export class TreeviewItem {
  ...
  get userCreated(): boolean {
    return this.internalUserCreated;
  }

  set userCreated(value: boolean) {
    if (this.internalUserCreated !== value) {
      this.internalUserCreated = value;
    }
  }

  get accAccountId(): string {
    return this.internalAccAccountId;
  }

  set accAccountId(value: string) {
    if (this.internalAccAccountId !== value) {
      this.internalAccAccountId = value;
    }
  }
